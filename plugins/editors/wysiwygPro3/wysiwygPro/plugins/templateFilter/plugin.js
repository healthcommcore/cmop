...
var re_m = new RegExp('(<[a-z][^>]*)(('+WPro.quoteMeta(tagOpen)+')[\\s\\S]*?('+WPro.quoteMeta(tagClose)+'))', 'gi')
var re_b = new RegExp('(^<[a-z][^>]*)'+WPro.quoteMeta(tagOpen)+'[\\s\\S]*', 'i');
var re_a = new RegExp('^<[a-z][^>]*'+WPro.quoteMeta(tagOpen)+'', 'i');
