...
p.WPRO_FB_RETURN_FUNCTION['<?php echo addslashes((isset($editor->sess) ? $editor->sess->sessionName : 'wprosid').'='.(isset($editor->sess) ? $editor->sess->sessionId : '')) ?>'] = p.<?php echo preg_replace("/[^a-zA-Z0-9_]/smi", '', $returnFunction) ?>;
</script>
