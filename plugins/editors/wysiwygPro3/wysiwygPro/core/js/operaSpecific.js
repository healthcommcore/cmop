...
var sel = obj.editWindow.getSelection()
var range = sel.getRangeAt(0)
var startContainer = range.startContainer
var container = startContainer.parentNode
var node = WPro.getBlockParent(container)
if (node.firstChild) {
...
var startContainer = range.startContainer
var container = startContainer.parentNode
var parentTag = WPro.getBlockParent(container)
