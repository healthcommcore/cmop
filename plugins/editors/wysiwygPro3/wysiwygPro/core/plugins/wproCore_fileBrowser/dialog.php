...
class wproDialogPlugin_wproCore_fileBrowser {
	...
	function init(&$DIALOG) {		global $EDITOR;
	...
	function displayFolderListWrapper($folderId=0, $folderPath='', $page=1, $sortBy='name', $sortDir='asc', $view='thumbnails', $highlight=array(), $history=true, $fakeresponse=NULL, $noError=false) {
		global $DIALOG;
	...
	function displayFolderList($folderId=0, $folderPath='', $page=1, $sortBy='name', $sortDir='asc', $view='thumbnails', $highlight=array(), $history=true, &$response, $noError=false) {
		global $EDITOR, $DIALOG, $WPRO_SESS;
