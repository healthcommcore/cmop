...
if (!defined('IN_WPRO')) exit;
				...
				$mode = preg_replace("/[^a-z]/smi", '', isset($params['mode']) ? $params['mode'] : '');
				$current = preg_replace("/[^a-z]/smi", '', isset($params['current']) ? $params['current'] : '');
				...
				$requiredPermissions = preg_replace("/[^a-z,]/smi", '', isset($params['requiredPermissions']) ? $params['requiredPermissions'] : '');
				...
				$DIALOG->template->assign('current', isset($current) ? $current : '');
?>