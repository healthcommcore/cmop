...
if (!defined('IN_WPRO')) exit;
				...
				$type = preg_replace("/[^a-z,]/smi", '', isset($params['dirs'])?$params['dirs']:'link');
				...
				$DIALOG->headContent->add('<!--[if IE]><style type="text/css">#sitePreview{zoom:50%;width:760px;height:670px;}</style><![endif]-->');
