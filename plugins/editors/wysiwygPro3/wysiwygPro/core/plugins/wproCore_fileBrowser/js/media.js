...
var attrs = ['width','height','style','class','hspace','vspace','border','align','title','alt'];
...
if (o['embed']) o['embed']['style'] = node.style.cssText;
}
} else {
...
var location = dialog._domain+dialog.URL;
currentEditor.insertImage(location+'core/images/placeholder.gif', {'width':width,'height':height,'style':istyle,'class':'wproFilePlugin'+className,'hspace':hspace,'vspace':vspace,'border':border,'align':align,'title':title,'alt':alt,'_wpro_media_data':escape(mediaData)}, style);
}