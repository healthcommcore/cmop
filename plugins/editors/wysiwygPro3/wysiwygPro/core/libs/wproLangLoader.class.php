...
class wproLangLoader extends wproCore {
	...
	*/
	function load (&$EDITOR) {
		...
		$this->preferredLang = preg_replace('/[^a-z0-9\-_]/smi', '', $this->preferredLang);
		$this->defaultLang = preg_replace('/[^a-z0-9\-_]/smi', '', $this->defaultLang);
	...
	*/
	...
	function loadFile($filename) {
		...
		$filename = preg_replace('/[^a-z0-9\-_.\/]/smi', '', $filename);
		$this->preferredLang = preg_replace('/[^a-z0-9\-_]/smi', '', $this->preferredLang);
		$this->defaultLang = preg_replace('/[^a-z0-9\-_]/smi', '', $this->defaultLang);
