...
class wproImageEditor {
	...
	function rotate($file, $outputfile='', $degrees, $jpgQuality=60) {
	...
	function _imageRotateJpeg( $file, $output, $degrees, $width, $height, $origwidth, $origheight, $quality=60 ) {
	...
	function crop ($file, $outputfile='', $posx, $posy, $width, $height, $jpgQuality=60) {
		if ( !file_exists( $file )) return false;
	...
	function resize ($file, $outputfile='', $width=500, $height=500, $jpgQuality=60) {
