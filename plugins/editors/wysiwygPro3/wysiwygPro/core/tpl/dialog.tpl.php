...
dialog.browserVersion = <?php echo preg_replace("/[^0-9.]/smi", '', $EDITOR->_browserVersion) ?>;
...
<form action="<?php echo htmlspecialchars($formAction) ?>" name="dialogForm" id="dialogForm" <?php if (!empty($formEnctype)) : ?>enctype="<?php echo htmlspecialchars($formEnctype) ?>" <?php endif ?>method="<?php echo htmlspecialchars($formMethod) ?>" onsubmit="<?php echo htmlspecialchars($formOnSubmit) ?>" onclick="dialog.PMenu.closePMenu()">
<?php endif ?>
