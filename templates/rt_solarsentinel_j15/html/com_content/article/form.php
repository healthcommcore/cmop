...
<div class="component-header"><div class="componentheading<?php echo $this->params->get('pageclass_sfx')?>"><?php echo $this->escape($this->params->get('page_title')); ?></div></div>
<?php endif; ?>
...
<legend><?php echo JText::_('Metadata'); ?></legend>
	...
	<input type="hidden" name="Returnid" value="<?php echo $Itemid; ?>" />
