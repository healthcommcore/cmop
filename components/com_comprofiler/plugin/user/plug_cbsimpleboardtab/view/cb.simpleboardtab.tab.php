	...
	function ShowPosts( $template, $forum, $model ) {
		...
		if ( $template->posts ) {
			...
			$html				.=	'<table width="100%" cellspacing="0" cellpadding="3" border="0">'
								...
								.		'</tr>'
								.		'<tr class="sectiontableheader">'
								.			'<th width="%15">' . $template->titles->date . '</th>'
								.			'<th width="%30">' . $template->titles->subject . '</th>'
								.			'<th width="%20">' . $template->titles->category . '</th>'
								.			'<th width="%15">' . $template->titles->hits . '</th>'
								.		'</tr>'
								.	'</thead>'
								.	'<tbody>';
